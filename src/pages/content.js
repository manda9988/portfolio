...
export const about = {
  paragraph1:
    "Formé à l'école O'Clock et par mes expériences autodidactes, je me suis consacré au développement web depuis 3 ans. J'ai acquis de bonnes compétences en pratiquant des technologies variées comme: JavaScript, SCSS, Svelte, React, Node.js, Express et PostgreSQL.",
  paragraph2:
